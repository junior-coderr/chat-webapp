...
fetch('https://chat-8953.onrender.com/logout',{
    headers: {
...
function search_user(event){
    ...
    fetch('https://chat-8953.onrender.com/user/search',{
        headers: {
            'Content-Type': 'application/json'
        },
        method:'POST',
...
(function get_all_the_chats(){
    fetch('https://chat-8953.onrender.com/chats/get',{
        headers: {
            'Content-Type': 'application/json'
        },
        method:'POST',
...
user.addEventListener('click',async ()=>{
    ...
    connection= await io('https://chat-8953.onrender.com/',{
